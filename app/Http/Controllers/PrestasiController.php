...
class PrestasiController extends Controller
{
    ...
    $request->hasfile("piagam")
        ...
        $piagam = $request->file('piagam')->store('piagam');
    }
        ...
        $daftar_afirmasi = new DataSiswaPrestasi();
        ...
        $daftar_afirmasi->piagam = $piagam;

        $daftar_afirmasi->save();
        $dataPendaftaran = DataSiswaPrestasi::get();

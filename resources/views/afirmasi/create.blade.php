...
@php
    $title = "PPDB Jalur Afirmasi SMP Cempaka Tahun Ajaran 2024/2025";
@endphp
@section('content')
...
<div class="container-xl">
    <div class="col-12">
        <br>
        <div class="card">
            <form action="{{route('afirmasi.create')}}" method="post" class="card" enctype="multipart/form-data" >
                @csrf
                <div class="card-header">
                    <h3 class="card-title">Formulir Pendaftaran Siswa Jalur Afirmasi</h3>
                </div>
                <div class="card-body">
                    <br>
                    <div class="col-xl">
                        ...
                        <div class="col-xl">
                            ...
                            <div class="col-md-6 col-xl-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="dropzone-msg-desc">Upload dalam .png/.jpg</span>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Upload Transkrip Nilai Raport</label>
                                    <span class="dropzone-msg-desc">Transkrip nilai raport kelas 5 dan 6 semester 1 terlegalisir. Upload dalam .pdf</span>
                                    <input type="file" class="form-control 
                                        @error('raport')
                                            is-invalid
                                        @enderror" 
                                        name="raport" value="{{old('raport')}}">
                                        @error('raport')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Upload Kartu Tanda Siswa</label>
                                    <span class="dropzone-msg-desc">Upload dalam .pdf/.jpg/.png</span>
                                    <input type="file" class="form-control 
                                        @error('kts')
                                            is-invalid
                                        @enderror" 
                                        name="kts" value="{{old('kts')}}">
                                        @error('kts')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Upload Surat Keterangan Lulus</label>
                                    <span class="dropzone-msg-desc">Upload dalam .pdf</span>
                                    <input type="file" class="form-control 
                                        @error('skl')
                                            is-invalid
                                        @enderror" 
                                        name="skl" value="{{old('skl')}}">
                                        @error('skl')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Upload Surat Pernyataan Keaslian Dokumen</label>
                                    <span class="dropzone-msg-desc">Upload dalam .pdf</span>
                                    <input type="file" class="form-control 
                                        @error('spkd')
                                            is-invalid
                                        @enderror" 
                                        name="spkd" value="{{old('spkd')}}">
                                        @error('spkd')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Upload KIP/SKTM</label>
                                    <span class="dropzone-msg-desc">Upload dalam .pdf</span>
                                    <input type="file" class="form-control 
                                        @error('kip')
                                            is-invalid
                                        @enderror" 
                                        name="kip" value="{{old('kip')}}">
                                        @error('kip')
                                            <span class="invalid-feedback">{{$message}}</span>
                                        @enderror
                                </div>

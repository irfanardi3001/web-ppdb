...
@php
    $title = "PPDB Jalur Pindahan SMP Cempaka Tahun Ajaran 2024/2025";
@endphp
@section('content')
<div class="container-xl">
    <div class="col-12">
        <br>
        <div class="card">
            <form action="{{route('pindahan.create')}}" method="post" class="card">
                @csrf
                <div class="card-header">
                    <h3 class="card-title">Formulir Pendaftaran Siswa Jalur Pindahan</h3>
                </div>
                <div class="card-body">
                    <br>
                    <div class="col-xl">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="dropzone" id="dropzone-5" action="./" autocomplete="off" novalidate>
                    ...
                    <div class="dz-message">
                      <h3 class="dropzone-msg-title">Upload Surat Keterangan Orang Tua Pindah</h3>
                      <span class="dropzone-msg-desc">Upload dalam .pdf</span>
                    </div>
                  </form>
                </div>

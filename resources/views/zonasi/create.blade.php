...
@php
    $title = "PPDB Jalur Zonasi SMP Cempaka Tahun Ajaran 2024/2025";
@endphp
@section('content')
<div class="container-xl">
    <div class="col-12">
        <br>
        <div class="card">
            <form action="{{route('zonasi.create')}}" method="post" class="card">
                @csrf
                <div class="card-header">
                    <h3 class="card-title">Formulir Pendaftaran Siswa Jalur Zonasi</h3>
                </div>
                <div class="card-body">
                    <br>
                    <div class="col-xl">
